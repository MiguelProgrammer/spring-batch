...
public class ClienteTransacaoLineMapperConfig {
    ...
    @Bean
    public PatternMatchingCompositeLineMapper line() {
    ...
    private Map<String, FieldSetMapper> fieldSetMappers() {
        Map<String, FieldSetMapper> setMapperMaps = new HashMap<>();
        setMapperMaps.put("0*", fieldSetMapper(Cliente.class));
        setMapperMaps.put("1*", fieldSetMapper(Transacao.class));
        return setMapperMaps;
    }
